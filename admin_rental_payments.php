...
<head>
    ...
    <style>
        ...
        .rp-card .rp-btn-manage { flex: 1; display: flex; align-items: center; justify-content: center; gap: 0.4rem; background: linear-gradient(135deg, var(--gold-dark) 0%, var(--gold) 100%); color: #fff; border: none; padding: 0.55rem; font-size: 0.78rem; font-weight: 700; border-radius: 4px; cursor: pointer; text-transform: uppercase; letter-spacing: 0.04em; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(212,175,55,0.18); text-decoration: none; }
