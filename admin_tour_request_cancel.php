                    ...
                    <tr>
                        <td style="padding:48px 48px 40px 48px;">
                            ...
                            <p style="margin:0 0 32px 0;font-size:15px;color:#cccccc;line-height:1.8;">
                                We regret to inform you that your tour request has been cancelled by our administration team.
                            </p>
                            ...
                            <div style="background-color:#0d1117;border-left:2px solid #2563eb;padding:16px 20px;margin:0 0 24px 0;">
                                <p style="margin:0;font-size:13px;color:#999999;line-height:1.6;">
                                    ...
                                    You may submit a new tour request or explore other available properties. We apologize for any inconvenience this may have caused.
                                </p>
                            </div>
